...
+ (void)removeGesturePassword{//取消密码
    NSUserDefaults  * ud = [NSUserDefaults standardUserDefaults];
    [ud removeObjectForKey:KWHC_ConfigurationKey];
    [ud synchronize];
    UIViewController *vc=[WHC_GestureUnlockScreenVC getCurrentVC];
    [vc setValue:@NO forKey:@"passIsSet"];
    [vc setValue:@(UnknownType) forKey:@"passType"];
}
...
- (void)saveConfigurationInfo{
    ...
    _setState = YES;
    UIViewController *vc=[WHC_GestureUnlockScreenVC getCurrentVC];
    [vc setValue:@YES forKey:@"passIsSet"];
    [vc setValue:@(_unlockType) forKey:@"passType"];
